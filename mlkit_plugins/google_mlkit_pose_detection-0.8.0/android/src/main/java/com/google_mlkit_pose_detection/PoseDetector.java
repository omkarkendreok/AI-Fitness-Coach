                        ...
                        pose -> {
                            ...
                            if (!pose.getAllPoseLandmarks().isEmpty()) {
                                ...
                                for (PoseLandmark poseLandmark : pose.getAllPoseLandmarks()) {
                                    ...
                                    // 2D position only (ML Kit 17.x)
                                    landmarkMap.put("x", poseLandmark.getPosition().x);
                                    landmarkMap.put("y", poseLandmark.getPosition().y);

                                     // No Z coordinate available → set to 0
                                     landmarkMap.put("z", 0.0);

                                    landmarkMap.put("inFrameLikelihood", poseLandmark.getInFrameLikelihood());
